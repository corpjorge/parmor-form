...
<!--<![endif]-->
<table class="wrapper"
       style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #151513;"
            ...
            <div role="banner">
                <div class="preheader"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;">
                        ...
                        <div class="snippet"
                             style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #0071BC;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                ...
                <div class="header"
                    ...
                    <div class="logo emb-logo-margin-box"
                        ...
                        <div class="logo-center" align="center" id="emb-email-header"><img
                                style="display: block;height: auto;width: 100%;border: 0;max-width: 189px;"
                                src="http://parmor.co/images/inicio/logo_parmor.jpg" alt="" width="189"/></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            </div>
            <div>
                <div class="layout one-col fixed-width stack"
                    ...
                    <div class="layout__inner"
                         style="border-collapse: collapse;display: table;width: 100%;background-color: #151513;">
                        <!--[if (mso)|(IE)]>
                        <table align="center" cellpadding="0" cellspacing="0" role="presentation">
                            <tr class="layout-fixed-width" style="background-color: #151513;">
                                <td style="width: 600px" class="w560"><![endif]-->
                        <div class="column"
                             style="text-align: left;color: #565656;font-size: 17px;line-height: 26px;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                ...
                <div class="layout one-col fixed-width stack"
                     style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                    <div class="layout__inner"
                         style="border-collapse: collapse;display: table;width: 100%;background-color: #151513;background: 100% 36%/auto auto no-repeat url(https://i1.createsend1.com/ei/y/28/2BE/54A/122301/csfinal/Birthday-Template_13_13.png) #151513;background-position: 100% 36%;background-image: url(https://i1.createsend1.com/ei/y/28/2BE/54A/122301/csfinal/Birthday-Template_13_13.png);background-repeat: no-repeat;background-size: auto auto;">
                        <!--[if (mso)|(IE)]>
                        <table align="center" cellpadding="0" cellspacing="0" role="presentation">
                            <tr class="layout-fixed-width"
                                style="background: 100% 36%/auto auto no-repeat url(https://i1.createsend1.com/ei/y/28/2BE/54A/122301/csfinal/Birthday-Template_13_13.png) #151513;background-position: 100% 36%;background-image: url(https://i1.createsend1.com/ei/y/28/2BE/54A/122301/csfinal/Birthday-Template_13_13.png);background-repeat: no-repeat;background-size: auto auto;background-color: #151513;">
                                <td style="width: 600px" class="w560"><![endif]-->
                        <div class="column"
                             style="text-align: left;color: #565656;font-size: 17px;line-height: 26px;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
                ...
                <div class="layout one-col fixed-width stack"
                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;text-align: center;"><span
                                            style="color:#ffffff">Gracias por contactarnos</span>
                                    </p>
                                    <p style="Margin-top: 20px;Margin-bottom: 0;text-align: center;"><span
                                            style="color:#ffffff">Nos vemos muy pronto!</span></p>
                                </div>
                            </div>
                ...
                <div class="layout one-col fixed-width stack"
                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div>
                                    <div style="padding-top: 8px; text-align: center"><span style="padding-right: 4px;"><a
            ...
            <div role="contentinfo">
                ...
                <div class="layout email-flexible-footer email-footer"
                    ...
                    <div class="layout__inner center-aligned-footer"
                        ...
                        <!--[if (mso)|(IE)]>
                        <table style="width: 600px;" align="center" cellpadding="0" cellspacing="0" role="presentation">
                        <![endif]-->
                        <!--[if (mso)|(IE)]>
                        <tr class="layout-email-footer"><![endif]-->
                        <div class="column"
                             style="text-align: center;font-size: 12px;line-height: 19px;color: #0071BC;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;display: none;"
                             align="center">
                            ...
                            <tr>
                                <td>
                                    <div class="column js-footer-additional-info"
                                         style="text-align: center;font-size: 12px;line-height: 19px;color: #0071BC;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;display: inline;width: 100%;"
                                         align="center">
                                        <div
